...
export default async function handler(req, res) {
  ...
  const staticPages = [
    ...
    { url: '/investering-i-ejendom-stockholm', changefreq: 'monthly', priority: '0.8' },
    { url: '/investering-i-ejendom-oslo',      changefreq: 'monthly', priority: '0.8' },
    ...
    { url: '/vaerktoejer', changefreq: 'monthly', priority: '0.8' },
